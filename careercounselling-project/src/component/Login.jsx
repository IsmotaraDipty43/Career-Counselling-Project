...
<div className="mt-4 relative">
    ...
    >
        {showpass ? <FaEyeSlash /> : <FaEye />}
                        ...
                        {/* Google Login Button */}
                        <div className="mt-6">
                        <button onClick={handleGooglesign} className="w-full flex items-center justify-center px-4 py-2 bg-transparent border text-black font-medium rounded-md hover:bg-blue-600 focus:ring-2 focus:ring-blue-300">
                        ...
                        <p className="mt-4 text-center text-sm text-gray-600">
                            ...
                            <NavLink to="/reg" className="text-blue-500 hover:underline">
                                Register here
                            </NavLink>
                        </p>
                    </form>
